...
\begin{center}
	\begin{tabularx}{\textwidth}{|c|X|}
		...
		\hline
		ROV01 & Utilizzo del framework \hyperref[angular]{Angular} per lo sviluppo dell'applicazione\\
		\hline
		ROV02 & Utilizzo di MongoDb per la gestione dei dati\\
		\hline
		ROV03 & Utilizzo di \hyperref[tech-spring]{Spring} per il back-end dell'applicazione\\
		\hline
